...
dsn_hostname = "<replace with your DB2 hostname>" # e.g.: "dashdb-txn-sbox-yp-dal09-04.services.dal.bluemix.net"
dsn_uid = "<replace with your DB2 userid>"        # e.g. "abc12345"
dsn_pwd = "<replace with your DB2 password>"      # e.g. "7dBZ3wWt9XN6$o0J"
dsn_port = "<replace with your DB2 port>"                # e.g. "50000" 
